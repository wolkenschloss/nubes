...
public class RecipeRepositoryTest {
    ...
    public void findRecipe() {
        var clone = repository.findById(theRecipe._id()).await().indefinitely();
    ...
    public void updateRecipe() {
        repository.findById(theRecipe._id())
        ...
        Assertions.assertNotEquals(theRecipe, repository.findById(theRecipe._id()).await().indefinitely());
    }

    @Test
    @DisplayName("should delete recipe")
    public void deleteRecipe() {
        repository.deleteById(theRecipe._id()).await().indefinitely();
